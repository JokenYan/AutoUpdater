...
namespace UpdateApp.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   查找类似 The new version is downloaded and the running program will be closed and updated! 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Found a new version, do you want to download the update now? 的本地化字符串。
        /// </summary>
        internal static string HasNewVersion {
            get {
